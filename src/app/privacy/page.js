      ...
      <main style={{
        ...
        <div style={{ 
          ...
          <h2 style={{
            ...
            4. Add-ons and &ldquo;Mods&rdquo;
          </h2>

          <p style={{ marginBottom: '20px' }}>
            You can install Add-ons from addons.mozilla.org. Prism AI Browser periodically checks for updates to these Add-ons. You can also install &ldquo;Mods&rdquo; from prism-browser.app/mods. These Mods are hosted by our services and follow the same privacy policy our website. We do not collect any data from these Mods, they are purely static content that is downloaded to your device.
          </p>
